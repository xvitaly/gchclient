...
DnlNetLabelW=Загрузка Microsoft .NET Framework 4.6
DnlNetTextW=Эта программа требует установки Microsoft .NET Framework 4.6. Пожалуйста дождитесь окончания процесса скачивания файлов.
DnlNetReqAdm=Эта программа требует Microsoft .NET Framework 4.6, который может быть установлен только с правами администратора. Вам придётся установить его вручную!
DnlNetNeeded=Для работы программы SRC Repair требуется установленный пакет Microsoft .NET Framework 4.6, однако на Вашем компьютере он не обнаружен. Сейчас будет произведена его загрузка и установка с сервера Microsoft Download. Если у Вас установлен брандмауэр, разрешите программе установки доступ в Интернет.
